...
* card_all (Type: Array) คือ ไพ่ทั้งหมดในชุด พร้อมสถานะ โดยจะได้ออกมาเป็น type Array ที่มีรูปแบบเป็น column, row ดังนี้ [ [0,0] , [0,1] , [0,2] ] , [ [1,0] , [1,1] , [1,2] ] , [ [2,0] , [2,1] , [2,2] ] หรือมองให้เป็นตำแหน่งไพ่ จะได้
``` 
                                        [ [0,0] , [0,1] , [0,2] ] ,
                                        [ [1,0] , [1,1] , [1,2] ] ,
                                        [ [2,0] , [2,1] , [2,2] ]
